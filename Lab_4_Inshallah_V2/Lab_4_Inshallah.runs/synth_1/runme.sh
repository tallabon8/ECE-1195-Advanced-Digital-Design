...
HD_PWD='C:/Users/travisallabon/Lab_4_Inshallah/Lab_4_Inshallah.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Overall_CPU_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Overall_CPU_wrapper.tcl
