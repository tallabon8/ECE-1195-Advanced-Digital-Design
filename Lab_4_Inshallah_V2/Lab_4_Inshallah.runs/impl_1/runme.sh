...
HD_PWD='C:/Users/travisallabon/Lab_4_Inshallah/Lab_4_Inshallah.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Overall_CPU_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Overall_CPU_wrapper.tcl -notrace
