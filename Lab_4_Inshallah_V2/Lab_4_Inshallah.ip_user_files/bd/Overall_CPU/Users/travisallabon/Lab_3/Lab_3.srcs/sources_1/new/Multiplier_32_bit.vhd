...
Port ( 
    ...
    DONE : out std_logic --done output to indicate the multiplication process has completed
);
end Multiplier_32_bit;
--declarations of component instances
architecture Behavioral of Multiplier_32_bit is
--fsm component
