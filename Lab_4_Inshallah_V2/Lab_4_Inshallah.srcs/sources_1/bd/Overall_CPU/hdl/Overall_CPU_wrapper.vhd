...
--Command     : generate_target Overall_CPU_wrapper.bd
--Design      : Overall_CPU_wrapper
...
end Overall_CPU_wrapper;

architecture STRUCTURE of Overall_CPU_wrapper is
  component Overall_CPU is
  port (
    DDR_0_cas_n : inout STD_LOGIC;
    DDR_0_cke : inout STD_LOGIC;
    DDR_0_ck_n : inout STD_LOGIC;
  ...
  end component Overall_CPU;
begin
Overall_CPU_i: component Overall_CPU
     port map (
