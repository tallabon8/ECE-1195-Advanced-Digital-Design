...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Bout [ create_bd_port -dir O -from 31 -to 0 Bout ]
  ...
  connect_bd_net -net CPU_memory_0_dataOut [get_bd_ports MemoryDataIn] [get_bd_pins Instruction_Register_0/MemData] [get_bd_pins Memory_Data_Register_0/MemData]
  ...
  connect_bd_net -net Control_Unit_8_0_MemWrite [get_bd_ports MemWrite] [get_bd_pins Control_Unit_8_0/MemWrite]
  ...
  connect_bd_net -net Reg_A_8_0_A_Q [get_bd_pins Multiplier_32_bit_0/A] [get_bd_pins Reg_A_8_0/A_Q] [get_bd_pins count_leading_ones_0/CLO_in] [get_bd_pins four2three_mux_8_0/D] [get_bd_pins two2one_mux_8_2/B]
  connect_bd_net -net Reg_B_8_0_B_Q [get_bd_ports Bout] [get_bd_pins Multiplier_32_bit_0/B] [get_bd_pins Reg_B_8_0/B_Q] [get_bd_pins four2two_mux_8_0/A]
  ...
  connect_bd_net -net two2one_mux_8_0_R [get_bd_ports MemoryAddress] [get_bd_pins two2one_mux_8_0/R]
