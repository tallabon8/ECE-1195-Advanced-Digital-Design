...
entity Shift_Left_2_28_8 is
Port (
    EN : in std_logic;
    SignExtOut : in std_logic_vector(25 downto 0); --output from the sign extend 
    Shift_2_Out : out std_logic_vector(27 downto 0)
 );
end Shift_Left_2_28_8;

architecture Behavioral of Shift_Left_2_28_8 is
begin
