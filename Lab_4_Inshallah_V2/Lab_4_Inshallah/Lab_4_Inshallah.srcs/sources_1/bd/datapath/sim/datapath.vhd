...
entity datapath is
  ...
  attribute CORE_GENERATION_INFO of datapath : entity is "datapath,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=datapath,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=29,numReposBlks=29,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=27,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of datapath is
  ...
  component datapath_dummyMemory_0_0 is
  port (
  ...
  end component datapath_dummyMemory_0_0;
  ...
  signal Control_Unit_8_0_MemRead : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  signal MemData_0_1 : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  signal NLW_dummyMemory_0_MemData_UNCONNECTED : STD_LOGIC_VECTOR ( 31 downto 0 );
...
begin
  CLK_0_1 <= CLK_0;
  MemData_0_1(31 downto 0) <= MemData_0(31 downto 0);
  RST_0_1 <= RST_0;
...
Control_Unit_8_0: component datapath_Control_Unit_8_0_0
     port map (
      ...
      MemRead(31 downto 0) => Control_Unit_8_0_MemRead(31 downto 0),
...
Instruction_Register_0: component datapath_Instruction_Register_0_0
     port map (
      ...
      MemData(31 downto 0) => MemData_0_1(31 downto 0),
      RST => RST_0_1
    );
Memory_Data_Register_0: component datapath_Memory_Data_Register_0_0
     port map (
      ...
      MemData(31 downto 0) => B"00000000000000000000000000000000",
...
dummyMemory_0: component datapath_dummyMemory_0_0
     port map (
      Address(31 downto 0) => two2one_mux_8_0_R(31 downto 0),
      MemData(31 downto 0) => NLW_dummyMemory_0_MemData_UNCONNECTED(31 downto 0),
      MemRead(31 downto 0) => Control_Unit_8_0_MemRead(31 downto 0),
      MemWrite => Control_Unit_8_0_MemWrite,
      WriteData(31 downto 0) => Reg_B_8_0_B_Q(31 downto 0)
    );
