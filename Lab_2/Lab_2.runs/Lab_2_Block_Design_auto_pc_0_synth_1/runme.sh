...
HD_PWD='C:/Users/travisallabon/Lab_2/Lab_2.runs/Lab_2_Block_Design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2_Block_Design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_2_Block_Design_auto_pc_0.tcl
