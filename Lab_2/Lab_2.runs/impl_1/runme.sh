...
HD_PWD='C:/Users/travisallabon/Lab_2/Lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2_Block_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_2_Block_Design_wrapper.tcl -notrace
