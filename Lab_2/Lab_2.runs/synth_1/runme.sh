...
HD_PWD='C:/Users/travisallabon/Lab_2/Lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2_Block_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_2_Block_Design_wrapper.tcl
