...
HD_PWD='C:/Users/travisallabon/Lab_1_Design_Adder/Lab_1_Design_Adder.runs/design_1_adder32bit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_adder32bit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_adder32bit_0_0.tcl
