...
proc create_root_design { parentCell } {
  ...
  # Create instance: adder32bit_0, and set properties
  set block_name adder32bit
  set block_cell_name adder32bit_0
  if { [catch {set adder32bit_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adder32bit_0 eq "" } {
  ...
  connect_bd_net -net adder32bit_0_Cout [get_bd_pins adder32bit_0/Cout] [get_bd_pins axi_regmap_0/REG2_IN]
  connect_bd_net -net adder32bit_0_S [get_bd_pins adder32bit_0/S] [get_bd_pins axi_regmap_0/REG0_IN]
  connect_bd_net -net axi_regmap_0_REG0_OUT [get_bd_pins adder32bit_0/A] [get_bd_pins axi_regmap_0/REG0_OUT]
  connect_bd_net -net axi_regmap_0_REG1_OUT [get_bd_pins adder32bit_0/B] [get_bd_pins axi_regmap_0/REG1_OUT]
  connect_bd_net -net axi_regmap_0_REG2_OUT [get_bd_pins adder32bit_0/K] [get_bd_pins axi_regmap_0/REG2_OUT]
